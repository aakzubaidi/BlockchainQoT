...
@Contract(name = "MetricContract", info = @Info(title = "Metric contract", description = "My Smart Contract", version = "1.0.0", license = @License(name = "Apache-2.0", url = ""), contact = @Contact(email = "BlockchainQoT@example.com", name = "BlockchainQoT", url = "http://BlockchainQoT.me")))
@Default
public class MetricContract implements ContractInterface {
    ...
    @Transaction()
    public String evaluateComplianceE(Context ctx, String deltaID, String ProviderID, String fire,
    ...
    public String ComplianceAssessment(Context ctx, String ProviderID, String fromKey, String toKey,
        ...
        public void clean(Context ctx, String providerKey, String violationKey, String Deposite, String maxTolerance, String Penalty) {
            ...
            ctx.getStub().putState(providerKey, provider.toJSONString().getBytes(UTF_8));
            ctx.getStub().putState(violationKey, violationCategory.toJSONString().getBytes(UTF_8));
        }
